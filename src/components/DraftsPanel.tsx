            ...
            <div className="flex flex-col md:flex-row gap-4 max-w-5xl w-full max-h-[90vh]" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="flex-1 overflow-y-auto md:py-4 space-y-4">
                ...
                <div className="flex gap-2">
                  <button onClick={() => { onSchedule(fullscreenDraft); setFullscreenDraft(null); }} className="flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-xl bg-gradient-to-r from-[#3c4a30] to-[#7ab82e] text-black font-semibold text-sm transition-all"><CalendarIcon className="w-4 h-4" />Programar</button>
